//
//  letterPackPlusViewController.swift
//  letterPack
//
//  Created by 今井 秀一 on 2020/07/13.
...
class letterPackPlusViewController: UIViewController {
    ...
    let imageLetterPack:UIImage! = UIImage(named:"letterPackPlus")
...
//    let toTelRect = CGRect(x:295, y:380, width:imageWidth-250, height:80)
    ...
    //
      @IBAction func pluseShare() {
        
        //shareから遷移した際にシェアするアイテム
        let activityItems: [Any] = [shareText, shareUrl, self.shereImage!]
